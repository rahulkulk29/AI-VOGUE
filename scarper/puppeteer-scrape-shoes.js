// puppeteer-scrape-shoes.js
// Usage:
// 1) npm init -y
// 2) npm i puppeteer
// 3) node puppeteer-scrape-shoes.js
// Optionally pass a full URL as first arg to override the default Flipkart search:
//    node puppeteer-scrape-shoes.js "https://www.flipkart.com/search?q=shoes+for+men"

const puppeteer = require('puppeteer');

const DEFAULT_URL = 'https://www.flipkart.com/search?q=shoes+for+men';
...
async function openPage(browser, url) {
  ...
  // close common Flipkart login modal if present
  try {
...
async function scrape(page) {
  ...
  return await page.evaluate(() => {
    ...
    containers.forEach(container => {
      ...
      // Heuristic: ensure it's likely a shoe by presence of "shoe" image or brand or sizes numeric array
